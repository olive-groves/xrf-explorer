...
async function refreshProjects() {
  const res = await axios.get<ProjectsResponse>(`/api/projects/${username.value}`);
 ...
 * @param projectName The name of the project to give access to.
 */
async function giveAccess(projectName: string) {
  try {
    const response = await axios.post<GrantAccessResponse>("/api/grant_project_access", {
      username: username.value,
      project: projectName,
    });
 ...
 * @param projectName The name of the project to remove access from.
 */
async function removeAccess(projectName: string) {
  ...
  try {
    const response = await axios.post<GrantAccessResponse>("/api/revoke_project_access", {
      username: username.value,
      project: projectName,
    });
