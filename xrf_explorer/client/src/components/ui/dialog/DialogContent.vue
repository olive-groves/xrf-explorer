...
<template>
  <DialogPortal>
    ...
    <DialogContent
      ...
      :class="
        cn(
          `fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-2 border bg-background
          p-4 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out
    ...
    >
      ...
      <DialogClose
        class="absolute right-2 top-2 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100
