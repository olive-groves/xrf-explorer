...
<template>
  <Window title="Color segmentation">
    <!-- OVERLAY SECTION -->
    <p class="ml-1 font-bold">Selection:</p>
    <div class="mt-1 flex items-center">
      <Select v-model="selectedOverlay">
        ...
        <SelectContent>
          <SelectGroup>
            ...
            <SelectItem value="Whole"> Whole painting </SelectItem>
      ...
      <Button class="ml-4 block w-28" @click="fetchDRImage">Show colors</Button>
    </div>
    <!-- PARAMETERS SECTIONS
